        ...
        <table class="w-full text-sm">
            ...
            <tbody class="divide-y divide-gray-50">
                ...
                <tr class="hover:bg-gray-50 transition-colors">
                    ...
                    <td class="px-6 py-4 text-sm text-gray-600"><?= htmlspecialchars($user['position'] ?? '—') ?></td>
                    <td class="px-6 py-4">
                        <?php
                    ...
                    <td class="px-6 py-4">
                        <div class="flex items-center justify-end gap-1">
                            <a href="<?= BASE_URL ?>/admin/users/detail/<?= (string)$user['_id'] ?>"
                               class="p-2 text-gray-400 hover:text-emerald-600 hover:bg-emerald-50 rounded-lg transition-colors" title="View">
